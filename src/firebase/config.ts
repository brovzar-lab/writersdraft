...
const useEmulator = env.VITE_USE_EMULATOR !== 'false' && !env.VITE_FIREBASE_API_KEY

const firebaseConfig = {
  apiKey: env.VITE_FIREBASE_API_KEY ?? 'demo-api-key',
  authDomain: env.VITE_FIREBASE_AUTH_DOMAIN ?? 'writersdraft-demo.firebaseapp.com',
  projectId: env.VITE_FIREBASE_PROJECT_ID ?? 'writersdraft-demo',
  storageBucket: env.VITE_FIREBASE_STORAGE_BUCKET ?? 'writersdraft-demo.appspot.com',
